...
router.get(
  ...
  HeadDashboardController.getDashboardStats,
);
...
router.get(
  "/delegation-data/:userId",
  HeadDashboardController.getDelegationData,
);
...
// POST /api/head/projects/create
router.post("/projects/create", HeadDashboardController.createProject);

// GET /api/head/department-tasks/:headId
router.get(
  "/department-tasks/:headId",
  HeadDashboardController.getDepartmentTasks,
);
...
router.get(
  "/replacement-requests/:headId",
  HeadDashboardController.getReplacementRequests,
);

// PUT /api/head/replacement-requests/:requestId
router.put(
  "/replacement-requests/:requestId",
  HeadDashboardController.processReplacementRequest,
);

// Team Performance Routes
// GET /api/head/team-performance-overview/:headId
router.get(
  "/team-performance-overview/:headId",
  TeamPerformanceController.getOverview,
);

// GET /api/head/team-performance-members/:headId
router.get(
  "/team-performance-members/:headId",
  TeamPerformanceController.getMembersPerformance,
);

// GET /api/head/employee-insights/:empId
router.get(
  "/employee-insights/:empId",
  HeadDashboardController.getEmployeeInsights,
);
